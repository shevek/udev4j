...
public enum UdevProperty {
    ...
    UDISKS_MD_DEVNAME,
    UDISKS_MD_LEVEL,
    UDISKS_MD_MEMBER_DEVICES,
    UDISKS_MD_MEMBER_DEV_UUID,
    UDISKS_MD_MEMBER_EVENTS,
    UDISKS_MD_MEMBER_LEVEL,
    UDISKS_MD_MEMBER_NAME,
    UDISKS_MD_MEMBER_UPDATE_TIME,
